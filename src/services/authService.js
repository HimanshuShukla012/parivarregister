...
export const authService = {
  login: async (credentials) => {
    ...
    const csrfResponse = await fetch(
      "https://parivarregister.kdsgroup.co.in/csrf/",
      {
        credentials: "include",
      }
    );
    ...
    const response = await fetch("https://parivarregister.kdsgroup.co.in/", {
      method: "POST",
      headers: {
  ...
  forceLogout: async (loginID) => {
    ...
    const response = await fetch(
      "https://parivarregister.kdsgroup.co.in/force_logout/",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  logout: async () => {
    try {
      await fetch("https://parivarregister.kdsgroup.co.in/logout/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
