...
const SachivDashboard = () => {
  ...
  const [selectedGaonForVerification, setSelectedGaonForVerification] =
    useState(null);
  ...
  return (
    <div className="sachiv-dashboard-wrapper">
      ...
      <div className="sachiv-content" id="content">
        <div className="sachiv-main-content">
          <div className="sachiv-header">
            <span className="sachiv-title" id="registerTitle">
              {selectedVillage
                ? `${selectedVillage.gaon} रजिस्टर`
                : "No Pending Register"}
            </span>
          </div>

          {/* Show tabs only in verification mode */}
          {selectedVillage?.approvedBySachiv === "N" &&
              ...
              >
                <button
                  ...
                  style={{
                    padding: "10px 20px",
                    backgroundColor:
                      viewMode === "verification" ? "#667eea" : "transparent",
                ...
                <button
                  ...
                  style={{
                    padding: "10px 20px",
                    backgroundColor:
                      viewMode === "approved" ? "#667eea" : "transparent",
            ...
            <div className="sachiv-button-group">
              ...
              {viewMode === "approved" && (
                <button
                  ...
                  style={{
                    opacity:
                      gaonData.filter((row) => !row.status).length > 0
                        ? 0.5
                        : 1,
                    cursor:
                      gaonData.filter((row) => !row.status).length > 0
        ...
        {(viewMode === "approved" ||
          (viewMode !== "verification" && viewMode !== "completed")) && (
          <KeyLegend
            onScrollToError={() => {
