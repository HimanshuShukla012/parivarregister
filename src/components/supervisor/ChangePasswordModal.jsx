...
const ChangePasswordModal = ({ loginID, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await supervisorService.resetPassword(loginID, newPassword);
        ...
        <div style={{ padding: '20px' }}>
          ...
          <form id="changePassForm" onSubmit={handleSubmit}>
            <div className="hidden">
              <label htmlFor="changePassId">Login Id:</label>
              <input type="text" id="changePassId" value={loginID} readOnly />
            </div>
